...
public class TC14_PlaceOrder14 {
	
	
WebDriver driver;
	
	public  TC14_PlaceOrder14(WebDriver driver) {
		this.driver=driver;
	...
	//@FindBy(xpath = "//div[contains(text(),'Your order has been placed successfully!')]") public WebElement orderPlaced;
	...
	driver.manage().timeouts().implicitlyWait(3,TimeUnit.SECONDS);
	email.sendKeys("sushma12654698@gmail.com");
	driver.manage().timeouts().implicitlyWait(3,TimeUnit.SECONDS);
	submit.click();
	driver.manage().timeouts().implicitlyWait(3,TimeUnit.SECONDS);
